...
@Autonomous(name = "AS12NoGate", group = "Autonomous")
@Configurable // Panels
public class AS12NoGate extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            // go to shoot Spike 1 (Skipping Gate curve, direct line)
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 6:
                // Finish shooting Preload, go to Spike 1
            ...
            case 100:
                ...
                if (!follower.isBusy()) {
                    ...
                    if (pathTimer.getElapsedTimeSeconds() > pickupWaitTime) {
                        // GO STRAIGHT TO SHOOT (Skip Path 3 Gate curve)
            ...
            case 9:
                // Finish Spike 1, go to Spike 2 entry
                if (mixer.IsEmpty() || pathTimer.getElapsedTimeSeconds() > maxShootingTime) {
            ...
            case 14:
                // Finish Spike 2, go to Spike 3 entry
                if (mixer.IsEmpty() || pathTimer.getElapsedTimeSeconds() > maxShootingTime) {
