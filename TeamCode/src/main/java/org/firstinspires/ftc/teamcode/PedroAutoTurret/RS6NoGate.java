...
@Autonomous(name = "RS6NoGate", group = "Autonomous")
@Configurable // Panels
public class RS6NoGate extends OpMode {
    ...
    public void init() {
        ...
        mixer.SetArtifacts(); // Load 3 balls AFTER possible wipe
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            // position to shoot (Preload - Mirrored)
            Path1 = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(124.5, 121.6),
                            new Pose(90, 85)))
                    .setLinearHeadingInterpolation(Math.toRadians(306), Math.toRadians(0))
                    .build();

            // pick up Spike 1 (Mirrored)
            ...
            // go to shoot Spike 1 (Direct line, No Gate - Mirrored)
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 3:
                turret.setTrackingTag(false);
                turret.setTargetAngle(45); // Mirrored from -45
                setPathState(4);
                break;
            ...
            case 4:
                if (pathTimer.getElapsedTimeSeconds() > 0.5
                    ...
                    limeLight.RelocalizationRed(); // Use Red relocalization
