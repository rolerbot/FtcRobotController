...
@Autonomous(name = "RosuScurt9BallShortPark", group = "Autonomous")
@Configurable // Panels
public class RosuScurt9BallShortPark extends OpMode {
    ...
    private PathChain Path8; // prepare to shoot
    private PathChain Path9; // go to shoot
    ...
    public void buildPaths() {
        ...
        // Path 10: Park
        // Blue: (53.000, 92.000, 136°) → (43, 80, 90°)
        // Red: (91.000, 92.000, 44°) → (101, 80, 90°)
