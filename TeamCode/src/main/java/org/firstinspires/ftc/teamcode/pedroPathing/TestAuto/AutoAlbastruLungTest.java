...
@Autonomous(name = "AutoAlbastruLungTest", group = "Pedro Pathing")
public class AutoAlbastruLungTest extends OpMode {
    ...
    private final double pickupWaitTime = 1; // seconds - half time for ball pickup
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 4:
                ...
                if (shooter.AutoShoot() && pathTimer.getElapsedTimeSeconds() > 3) { // Returns true when done
            ...
            case 8:
                ...
                if (shooter.AutoShoot() &&  pathTimer.getElapsedTimeSeconds() > 3) {
