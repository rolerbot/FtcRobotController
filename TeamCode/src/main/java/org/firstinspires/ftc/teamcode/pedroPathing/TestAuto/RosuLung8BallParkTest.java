...
@Autonomous(name = "RosuLung8BallParkTest", group = "Autonomous")
@Configurable // Panels
public class RosuLung8BallParkTest extends OpMode {
    ...
    public void buildPaths() {
        ...
        Path2 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(69.7))
                .build();
        ...
        Path5 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(69.7))
                .build();
        ...
        Path6 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(69.7), Math.toRadians(-9.7))
                .build();
        ...
        Path7 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(-9.7), Math.toRadians(-9.7))
                .build();
        ...
        Path8 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(-9.7), Math.toRadians(69.7))
                .build();
        ...
        Path9 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(69.7), Math.toRadians(90))
                .build();
    }
